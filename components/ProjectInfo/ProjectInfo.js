...
export default function ProjectInfo({ currentProjectInfo, ...props }) {
  return (
      ...
      <div className={`${poppins.className} ${styles.container}`}>
        ...
        <div>
          <div className={styles["svg-heading-pair"]}>
            ...
            <h3 className={styles["section-heading"]}>Github</h3>
          </div>
          <a
            target="_blank"
            href={currentProjectInfo.githubUrl}
            className={styles["link"]}
          >
            {currentProjectInfo.githubUrl}
          </a>
        </div>
      </div>
      <a
        target="_blank"
        href={currentProjectInfo.url}
        className={`${styles["open-project-button"]} ${poppins.className}`}
      >
        <div className={styles["open-project-text"]}>
          <span className={styles.link}>Open Project</span>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
